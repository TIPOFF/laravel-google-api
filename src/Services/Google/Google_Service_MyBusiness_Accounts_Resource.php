...
class Google_Service_MyBusiness_Accounts_Resource extends Google_Service_Resource
{
    ...
    public function deleteNotifications($name, $optParams = [])
    {
        ...
        return $this->call('deleteNotifications', [$params], 'Google_Service_MyBusiness_MybusinessEmpty');
    }
    ...
    public function generateAccountNumber($name, Google_Service_MyBusiness_GenerateAccountNumberRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('generateAccountNumber', [$params], 'Google_Service_MyBusiness_Account');
    }
    ...
    public function get($name, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'Google_Service_MyBusiness_Account');
    }
    ...
    public function getNotifications($name, $optParams = [])
    {
        ...
        return $this->call('getNotifications', [$params], 'Google_Service_MyBusiness_Notifications');
    }
    ...
    public function listAccounts($optParams = [])
    {
        ...
        return $this->call('list', [$params], 'Google_Service_MyBusiness_ListAccountsResponse');
    }
    ...
    public function listRecommendGoogleLocations($name, $optParams = [])
    {
        ...
        return $this->call('listRecommendGoogleLocations', [$params], 'Google_Service_MyBusiness_ListRecommendedGoogleLocationsResponse');
    }
    ...
    public function update($name, Google_Service_MyBusiness_Account $postBody, $optParams = [])
    {
        ...
        return $this->call('update', [$params], 'Google_Service_MyBusiness_Account');
    }
    ...
    public function updateNotifications($name, Google_Service_MyBusiness_Notifications $postBody, $optParams = [])
    {
        ...
        return $this->call('updateNotifications', [$params], 'Google_Service_MyBusiness_Notifications');
    }
}
