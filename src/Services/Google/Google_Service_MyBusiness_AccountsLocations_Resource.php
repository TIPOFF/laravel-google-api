...
class Google_Service_MyBusiness_AccountsLocations_Resource extends Google_Service_Resource
{
    ...
    public function associate($name, Google_Service_MyBusiness_AssociateLocationRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('associate', [$params], 'Google_Service_MyBusiness_MybusinessEmpty');
    }
    ...
    public function batchGet($name, Google_Service_MyBusiness_BatchGetLocationsRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('batchGet', [$params], 'Google_Service_MyBusiness_BatchGetLocationsResponse');
    }
    ...
    public function batchGetReviews($name, Google_Service_MyBusiness_BatchGetReviewsRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('batchGetReviews', [$params], 'Google_Service_MyBusiness_BatchGetReviewsResponse');
    }
    ...
    public function clearAssociation($name, Google_Service_MyBusiness_ClearLocationAssociationRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('clearAssociation', [$params], 'Google_Service_MyBusiness_MybusinessEmpty');
    }
    ...
    public function create($parent, Google_Service_MyBusiness_Location $postBody, $optParams = [])
    {
        ...
        return $this->call('create', [$params], 'Google_Service_MyBusiness_Location');
    }
    ...
    public function fetchVerificationOptions($name, Google_Service_MyBusiness_FetchVerificationOptionsRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('fetchVerificationOptions', [$params], 'Google_Service_MyBusiness_FetchVerificationOptionsResponse');
    }
    ...
    public function findMatches($name, Google_Service_MyBusiness_FindMatchingLocationsRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('findMatches', [$params], 'Google_Service_MyBusiness_FindMatchingLocationsResponse');
    }
    ...
    public function get($name, $optParams = [])
    {
        ...
        return $this->call('get', [$params], 'Google_Service_MyBusiness_Location');
    }
    ...
    public function getGoogleUpdated($name, $optParams = [])
    {
        ...
        return $this->call('getGoogleUpdated', [$params], 'Google_Service_MyBusiness_GoogleUpdatedLocation');
    }
    ...
    public function listAccountsLocations($parent, $optParams = [])
    {
        ...
        return $this->call('list', [$params], 'Google_Service_MyBusiness_ListLocationsResponse');
    }
    ...
    public function patch($name, Google_Service_MyBusiness_Location $postBody, $optParams = [])
    {
        ...
        return $this->call('patch', [$params], 'Google_Service_MyBusiness_Location');
    }
    ...
    public function reportInsights($name, Google_Service_MyBusiness_ReportLocationInsightsRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('reportInsights', [$params], 'Google_Service_MyBusiness_ReportLocationInsightsResponse');
    }
    ...
    public function transfer($name, Google_Service_MyBusiness_TransferLocationRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('transfer', [$params], 'Google_Service_MyBusiness_Location');
    }
    ...
    public function verify($name, Google_Service_MyBusiness_VerifyLocationRequest $postBody, $optParams = [])
    {
        ...
        return $this->call('verify', [$params], 'Google_Service_MyBusiness_VerifyLocationResponse');
    }
}
